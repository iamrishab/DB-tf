...
from lib.networks.resnet import resnet_utils
...
def resnet_v1_tiny(inputs,
  ...
  with tf.variable_scope(scope, 'resnet_v1', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, bottleneck_tiny,
...
resnet_v1_tiny.default_image_size = 224
...
def resnet_v1_block(scope, base_depth, num_units, stride):
  ...
  """
  return resnet_utils.Block(scope, bottleneck_tiny, [{
      'depth': base_depth * 4,
...
def resnet_v1_18(inputs,
  ...
  return resnet_v1_tiny(inputs, blocks, num_classes, is_training,
                   global_pool=global_pool, output_stride=output_stride,
                   include_root_block=True, spatial_squeeze=spatial_squeeze,
                   store_non_strided_activations=store_non_strided_activations,
                   reuse=reuse, scope=scope)
resnet_v1_18.default_image_size = resnet_v1_tiny.default_image_size
...
def resnet_v1_34(inputs,
  ...
  return resnet_v1_tiny(inputs, blocks, num_classes, is_training,
                   ...
                   store_non_strided_activations=store_non_strided_activations,
                   reuse=reuse, scope=scope)
resnet_v1_34.default_image_size = resnet_v1_tiny.default_image_size
